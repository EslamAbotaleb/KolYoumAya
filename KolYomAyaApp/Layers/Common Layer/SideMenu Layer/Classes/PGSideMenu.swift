...
open class PGSideMenu: UIViewController {
    ...
    // MARK: Outlets
    static var shared: PGSideMenu = PGSideMenu(animationType: .slideOver)
    ...
    public var isLeftMenu: Bool = false
    ...
    public var menuAnimationDuration: TimeInterval = 0.2
    ...
    public init(animationType: PGSideMenuAnimationType) {
        ...
        let bundle = Bundle(for: PGSideMenu.self)
